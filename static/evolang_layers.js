...
(() => {
  ...
  const NODES = [
    ...
    { id: "sem_collo", name: "Collocation strength", layer: "semantic", stages: ["fill"], status: "planned",
      short: "is this a real fixed phrase pair?",
      desc: "PLANNED, not yet attempted. Tighter than loose window co-occurrence — is this SPECIFIC word pair a common fixed collocation (\"salt and pepper\", \"make a decision\") vs merely topically related but rarely paired together." },
    ...
    { id: "sent_type", name: "Sentence type", layer: "structural", stages: ["skeleton"], status: "planned",
      short: "statement, question, imperative?",
      desc: "PLANNED, not yet attempted. Nothing currently decides sentence SHAPE before generating — this would drive different class sequences per type instead of one undifferentiated skeleton." },
    { id: "sent_lenplan", name: "Sentence length plan", layer: "structural", stages: ["skeleton"], status: "planned",
      short: "how long should this sentence be?",
      desc: "PLANNED, not yet attempted. Boundary currently decides length AFTER generation, one word at a time. A pre-planned target length would let the skeleton pace itself toward a natural close instead of the closer reshaping after the fact." },
    { id: "clause_count", name: "Clause count", layer: "structural", stages: ["skeleton"], status: "planned",
      short: "simple or compound sentence?",
      desc: "PLANNED, not yet attempted. Nothing decides \"one clause\" vs \"X, and Y\" before the skeleton runs — a coarser, upstream cousin of the already-cut Clause template genome (that one failed at the class-trigram level; this one would act before any classes are chosen at all)." },

    { id: "definite", name: "Definiteness", layer: "semantic", stages: ["fill"], status: "planned",
      short: "\"a\" vs \"the\" — new or known entity?",
      desc: "PLANNED, not yet attempted. \"a\" vs \"the\" tracks whether a noun's referent is a first mention or already known — nothing currently tracks entity identity across a passage to inform this choice." },
    { id: "verb_prep", name: "Verb-preposition", layer: "structural", stages: ["fill"], status: "planned",
      short: "\"depend ON\", not \"depend AT\"",
      desc: "PLANNED, not yet attempted. Fixed verb-preposition collocations (subcategorization) — a lexical-grammatical fact about specific verbs, not a meaning distinction, so structural rather than semantic." },
    { id: "transitivity", name: "Transitivity", layer: "structural", stages: ["fill"], status: "planned",
      short: "verb needs an object?",
      desc: "PLANNED, not yet attempted. If a verb requires an object, one must follow. Word-level (not class-level), so it may dodge the redundancy wall that cut the earlier class-level Verb argument genome." },
